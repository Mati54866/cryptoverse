...
const CryptoDetails = () => {
  ...
  // Add a check to prevent errors if cryptoDetails is undefined
      ...
      <Col className="stats-container">
        <Col className="coin-value-statistics">
          ...
          {stats.map(({ icon, title, value }, index) => (
            <Col className="coin-stats" key={`stats-${title}-${index}`}>
        ...
        <Col className="other-stats-info">
          ...
          {genericStats.map(({ icon, title, value }, index) => (
            <Col className="coin-stats" key={`generic-${title}-${index}`}>
              <Col className="coin-stats-name">
                <Text>{icon}</Text>
                <Text>{title}</Text>
              </Col>
      ...
      <Col className="coin-desc-link">
        ...
        <Col className="coin-links">
          ...
          {cryptoDetails.links?.map((link, index) => (
            <Row className="coin-link" key={link.name || `link-${index}`}>
